	...
	<div class="wrapper">
		...
		<div class="login_box">
			...
			<div class="login_header">
				...
				Login using one of the provided login in the report or sign up !
			</div>
			<br>
			<div id="first">
				...
				<form action="register.php" method="POST">
					...
					<input type="submit" name="login_button" value="Login" id ="accept_button">
					<br>
			...
			<div id="second">
				...
				<form action="register.php" method="POST">
					...
					<br>
					<input type="submit" name="register_button" value="Register" id ="accept_button">
					<br>

					<?php if(in_array("<span style='color: #14C800;'>You're all set! Go ahead and login!</span><br>", $error_array)) echo "<span style='color: #14C800;'>You're all set! Go ahead and login!</span><br>"; ?>
					<a href="#" id="signin" class="signin">click here to Sign in!</a>
				</form>
			</div>
